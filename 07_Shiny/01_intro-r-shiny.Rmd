...
Great sources for tutorials and learning more about Shiny can be found [here](https://shiny.rstudio.com/tutorial/) and [here](https://mastering-shiny.org/). Our lectures on Shiny are adapted from these sources. A handy [Shiny cheat sheet](https://shiny.rstudio.com/images/shiny-cheatsheet.pdf) is also available.
