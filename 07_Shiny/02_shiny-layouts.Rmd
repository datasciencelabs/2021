...
## Page with sidebar
`sidebarLayout()`, along with `headerPanel()`, `sidebarPanel()`, and `mainPanel()`, makes it easy to create a two-column layout with inputs on the left and outputs on the right. The basic code is shown below, it generates the structure shown in the figure below.
