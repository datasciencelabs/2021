...
<center><img src="images/simulate_button.png" style="width: 220px;"/></center>

This doesn’t achieve our goal because it just introduces a new dependency: `x1()` and `x2()` will update when we click the simulate button, but they’ll also continue to update when `n1`, `n2`, `mean1`, `mean2`, `sd1`, or `sd2` change. We want to replace the existing dependencies, not add to them.
